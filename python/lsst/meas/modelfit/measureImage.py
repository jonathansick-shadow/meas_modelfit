...
class MeasureImageTask(BaseMeasureTask):
    ...
    def prepCatalog(self, inputs):
        ...
        exposureUnits = modelfitLib.UnitSystem(inputs.exposure)
        ...
        mapper.addMinimalSchema(lsst.meas.modelfit.ModelFitTable.makeMinimalSchema())
        ...
        for srcRecord in srcCat:
            ...
            transform = modelfitLib.LocalUnitTransform(outRecord.getCoord(), exposureUnits, units)
            ...
            ellipses = lsst.meas.modelfit.Model.EllipseVector()
    ...
    def makeLikelihood(self, inputs, record):
        ...
        return modelfitLib.UnitTransformedLikelihood(
    ...
    def getSchemaCatalogs(self):
        ...
        return {self.dataPrefix + "modelfits": modelfitLib.ModelFitCatalog(self.makeTable())}
